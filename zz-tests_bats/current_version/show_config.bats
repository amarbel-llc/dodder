...
function show_config_after_edit_config_roundtrips { # @test
  ...
  assert_success
  assert_output --regexp '^\[konfig @blake2b256-[a-z0-9]+ [0-9.]+ dodder-repo-public_key-v1@ed25519_pub-[a-z0-9]+ dodder-object-sig-v2@ed25519_sig-[a-z0-9]+ !inventory_list-v2\]$'
}
