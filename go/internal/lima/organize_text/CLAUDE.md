...
- `Text`: Main organize text document with options and assignment tree
- `Assignment`: Hierarchical assignment node for organizing zettels
- `Options`: Configuration for text parsing and writing
- `Metadata`: Document metadata for organize text files
