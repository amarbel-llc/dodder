...
func DecodeV0(input []byte) (*V0Document, error) {
	...
	if tableNode := d.cstDoc.FindTableInContainer(d.cstDoc.Root(), "abbreviations"); tableNode != nil {
		...
		if v, err := document.GetFromContainer[bool](d.cstDoc, tableNode, "hinweisen"); err == nil {
	...
	if v, err := document.GetFromContainer[bool](d.cstDoc, d.cstDoc.Root(), "print-matched-archiviert"); err == nil {
	...
	if v, err := document.GetFromContainer[bool](d.cstDoc, d.cstDoc.Root(), "print-bestandsaufnahme"); err == nil {
...
func (d *V0Document) Encode() ([]byte, error) {
	if d.data.Abbreviations != nil {
		if tableNode := d.cstDoc.FindTableInContainer(d.cstDoc.Root(), "abbreviations"); tableNode != nil {
			if d.data.Abbreviations.ZettelIds != nil {
				if err := d.cstDoc.SetInContainer(tableNode, "hinweisen", *d.data.Abbreviations.ZettelIds); err != nil {
					return nil, err
				}
			}
			if d.data.Abbreviations.Shas != nil {
				if err := d.cstDoc.SetInContainer(tableNode, "shas", *d.data.Abbreviations.Shas); err != nil {
					return nil, err
				}
			}
		}
	...
	if d.data.PrintMatchedDormant != nil {
		if err := d.cstDoc.SetInContainer(d.cstDoc.Root(), "print-matched-archiviert", *d.data.PrintMatchedDormant); err != nil {
			return nil, err
		}
	}
	...
	if d.data.PrintInventoryLists != nil {
		if err := d.cstDoc.SetInContainer(d.cstDoc.Root(), "print-bestandsaufnahme", *d.data.PrintInventoryLists); err != nil {
			return nil, err
		}
	}
