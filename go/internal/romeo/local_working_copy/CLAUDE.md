...
Main repository interface coordinating store, workspace, and index operations
for local working copies.

## Key Types

- `Repo`: Central repository coordinator with store, indexes, and workspace
  environments
...
- Supports pull, checkin, and reindex operations
